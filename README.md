...
* **Username + password in the app** — the everyday route. The credentials are
  ...
  the mensa account. The form speaks the **school-issued account** dialect
  (pupils, teachers — the login carries the school number); parent,
  Bildungsserver and SSO accounts use the browser route below.
