// Schulportal Hessen — mobile restyle, injected into the in-app browser.
//
// This is the body of `userscript/schulportal-mobile.user.js` with the
// ==UserScript== metadata block removed, so the exact same code runs in Safari
// and inside the app. Keep the two in sync: `Tools/sync-userscript.sh`.
