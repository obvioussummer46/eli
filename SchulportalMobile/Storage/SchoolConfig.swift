...
/// one-entry PR, not a fork; the entry ships with the next release. The app
/// deliberately does not fetch this file from anywhere at runtime — no
/// third-party request, nothing to list in the privacy policy, and until a
/// school's mensa tenant lands here, the always-visible Kennung field under
/// „Essen" covers the gap.
enum SchoolRegistry {
